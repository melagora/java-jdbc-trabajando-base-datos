	...
	private void modificar() {
		...
		Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
				.ifPresentOrElse(fila -> {
					...
					int elementoModificado;
					
					try {
						elementoModificado = this.productoController.modificar(nombre, descripcion, cantidad, id);
					} catch (SQLException e) {
						e.printStackTrace();
						throw new RuntimeException(e);
					}
					 JOptionPane.showMessageDialog(this, String.format("%d item modificado con éxito!", elementoModificado));
	            }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
	}
